...
export default function Home() {
  ...
  return <div className="page home-page">
    ...
    <section className="home-quick-links" aria-label="Choose your access">
      <article className="quick-link quick-link--student"><span>01</span><div><strong>I&apos;m a Student</strong><p>Browse events from every club on campus — workshops, screenings, tournaments, and more.</p></div><button type="button" className="button-primary" onClick={() => signInWithGoogle('/events')}>Continue</button></article>
      <article className="quick-link quick-link--admin"><span>02</span><div><strong>I&apos;m a Club Admin</strong><span className="quick-link-badge">Admins only</span><p>Create, edit, and manage events for the club(s) you administer.</p><small>We check your account against our approved admin list — if you&apos;re not on it, we&apos;ll point you back to browsing events.</small></div><button type="button" className="button-ghost" onClick={() => signInWithGoogle('/admin')}>Continue</button></article>
    </section>
